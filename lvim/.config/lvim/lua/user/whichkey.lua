...
-- unbind some of LunarVim's defaults
...
-- TODO is this useful? H is bound to nhls
-- lvim.builtin.which_key.mappings["H"] = { "<cmd> lua require('harpoon.cmd-ui').toggle_quick_menu()<cr>", "Harpoon Cmd Menu"}
...
-- override the LunarVim default lsp key
